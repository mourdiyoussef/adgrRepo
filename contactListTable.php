...
if(!empty($_GET['action']) and !empty($_GET['idContact'])){
    if($_GET['action']=='supp'){
        ...
        $dctrl->deleteConneur($_GET['idContact']);
                                    ...
                                    <tbody>
                                            <?php
                                                ...
                                                foreach($list as $d){
                                                    ...
                                                    echo "<td>
                                                                <a href='?action=supp&idDonneur=".$d->getIdContact()."'>Supprimer</a> |
                                                                <a href='donneurModForm.php?idDonneur=".$d->getIdContact()."'>Modifier</a>
                                                            </td>";
                                                    echo "</tr>";
                                                }
                                            ?>
