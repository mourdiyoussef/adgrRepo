...
$list = $dctrl->getAllNegativeDonneurApt();
...
<div class="content">
    ...
    <div class="mainbar">
        ...
        <!-- Page heading -->
        <div class="page-head">
            <h2 class="pull-left"><i class="icon-table"></i> Liste des donneurs apts pour un don pour la prochaine collecte</h2>
